...
#onready var cam = $Armature/Skeleton/Head/Camera
...
func play_sound(sound_name : String):
	...
	for audiop in $EmittingSounds.get_children():
	...
	if audioplayer != null:
		...
		audioplayer.global_transform.origin = $SoundEmitterPosition.global_transform.origin
		audioplayer.play()
	else:
